...
ELSE()
    ExternalProject_Add(
      ...
      CMAKE_COMMAND MKLROOT="$ENV{MKL_HOME}" cmake . -DCMAKE_INSTALL_PREFIX=${SCAFFOLD_INSTALL_DIR} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_FC_COMPILER=${CMAKE_FC_COMPILER}
    )
    SET(MATRIX_LIBS "")
