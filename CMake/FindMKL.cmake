...
IF(CMAKE_SIZEOF_VOID_P EQUAL 8)
  IF(CMAKE_COMPILER_IS_GNUCXX)
    SET(MKL_NAMES ${MKL_NAMES} mkl_gf_lp64)
  ELSE()
    SET(MKL_NAMES ${MKL_NAMES} mkl_intel_lp64)
  ENDIF()
ELSE(CMAKE_SIZEOF_VOID_P EQUAL 8)
  IF(CMAKE_COMPILER_IS_GNUCXX)
    SET(MKL_NAMES ${MKL_NAMES} mkl_gf)
  ELSE()
...
FOREACH (MKL_NAME ${MKL_NAMES})
  FIND_LIBRARY(${MKL_NAME}_LIBRARY
    NAMES ${MKL_NAME}
    PATHS /usr/lib64 /usr/lib /usr/local/lib64 /usr/local/lib /opt/intel/lib/intel64 /opt/intel/lib/ia32 /opt/intel/mkl/lib/lib64 /opt/intel/mkl/lib/intel64 /opt/intel/mkl/lib/ia32 /opt/intel/mkl/lib /opt/intel/*/mkl/lib/intel64 /opt/intel/*/mkl/lib/ia32/ /opt/mkl/*/lib/em64t /opt/mkl/*/lib/32 /opt/intel/mkl/*/lib/em64t /opt/intel/mkl/*/lib/32 $ENV{MKL_HOME}/lib/intel64 $ENV{MKL_HOME}/lib
    )
